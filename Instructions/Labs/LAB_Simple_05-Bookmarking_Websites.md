---
lab:
  title: 'Simple Lab 05: Bookmark Your Favorite Websites'
  module: Basic Browser Skills
  description: Learn how to bookmark websites for quick access later
  duration: 5 minutes
  level: 100
  islab: true
  primarytopics:
...
# Simple Lab 05 - Bookmark Your Favorite Websites

## Lab introduction

In this lab, you will learn how to bookmark websites so you can easily return to them later without having to remember or type the URL. Bookmarks are your browser's quick-access shortcuts.
...
1. Open your browser and navigate to `https://www.wikipedia.org`.

2. Wait for the page to load completely.

3. This is the website you will bookmark.
...
3. You should see "Wikipedia" in your recent bookmarks list.

4. Navigate to another website (e.g., `https://www.bbc.com`).

5. Bookmark this website as well using **Ctrl + D**.

6. Press **Ctrl + B** or access the **Bookmarks menu** again.

7. You should now see at least two bookmarked websites.
...
2. In the bookmarks list, click on **Wikipedia**.

3. Your browser will navigate directly to Wikipedia without you having to type the URL.

4. Return to the bookmarks menu and click on **BBC** (or whatever second website you bookmarked).
