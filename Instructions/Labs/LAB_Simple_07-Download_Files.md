---
lab:
  title: 'Simple Lab 07: Download Files from the Internet'
  module: Basic Browser Skills
  description: Learn how to download files from websites
  duration: 5 minutes
  level: 100
  islab: true
  primarytopics:
...
# Simple Lab 07 - Download Files from the Internet

## Lab introduction

In this lab, you will learn how to download files from websites. Downloading is how you save files from the internet to your computer.
...
In this task, you will find the file you just downloaded.
...
5. You can click on the file in the downloads panel to open it.

6. **Alternative method - Open Downloads folder:**
   - Press **Ctrl + J** to open the Downloads page
   - This shows all your downloaded files with a timestamp
   - You can click **Show in folder** to see the file in Windows Explorer
...
Downloading files is an essential skill for saving documents, images, software, and other content from the internet to your computer.
